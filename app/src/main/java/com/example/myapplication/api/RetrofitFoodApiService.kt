...
//    override suspend fun getDogtionaryEntriesFlow(): Flow<List<FullInformationRecipe>> = favoritesEntryFlow
    ...
    override suspend fun getRandomRecipe(): Response.FullInformationRecipe =
    ...
    override suspend fun getRecipeById(id: Int): Response.FullInformationRecipe =
    ...
    override suspend fun getRecipeBulk(): Flow<List<Response.FullInformationRecipe>> {
        TODO("Not yet implemented")
    }

    override suspend fun getRecipeInstructionsById(id: Int): List<Response.FullInformationRecipe.Steps> =
...
interface FoodApi {
    ...
    suspend fun getInformationBulk(
        @Query("apiKey") apiKey: String,
        @Query("number") number: Int = 1
    ): List<Response.FullInformationRecipe>
